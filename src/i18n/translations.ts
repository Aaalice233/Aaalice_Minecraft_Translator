...
export type TranslationKey =
  ...
  | "dictionary.selectLoaded"
  | "dictionary.bulkFilterAll"
  | "dictionary.bulkSelectionIds"
  | "dictionary.bulkSelectionQuery"
  | "dictionary.bulkSelectMatching"
  | "dictionary.bulkInvertLoaded"
  | "dictionary.bulkClearSelection"
  | "dictionary.bulkDeleteSelected"
  | "dictionary.bulkConfirmTitle"
  | "dictionary.bulkConfirm"
  | "dictionary.bulkConfirmFilter"
  | "dictionary.bulkConfirmAction"
  | "dictionary.bulkDeleted"
  | "editPanel.ariaClose"
  | "editPanel.ariaLabel"
...
const zhCn: TranslationMap = {
  ...
  "auto.error.failedEntries": "仍有 {count} 条翻译失败或缺失，已停止自动校对和打包。请重试或手动检查相关条目。",
  "nav.dashboard": "扫描",
  "nav.jobs": "翻译",
  "nav.validate": "校验",
  "nav.packages": "打包",
  ...
  "dictionary.searchPlaceholder": "搜索原文、译文、翻译键、模组名或文件名...",
  ...
  "dictionary.selectRow": "选择此条目",
  "dictionary.selectLoaded": "选择当前已加载条目",
  "dictionary.bulkFilterAll": "全部本地词库",
  "dictionary.bulkSelectionIds": "匹配 {total} 条，已选择 {selected} 条",
  "dictionary.bulkSelectionQuery": "匹配 {total} 条，已选择 {selected} 条（包含未加载条目）",
  "dictionary.bulkSelectMatching": "全选匹配项",
  "dictionary.bulkInvertLoaded": "反选已加载",
  "dictionary.bulkClearSelection": "清除选择",
  "dictionary.bulkDeleteSelected": "删除所选",
  "dictionary.bulkConfirmTitle": "确认批量删除",
  "dictionary.bulkConfirm": "将永久删除 {count} 条词库条目。此操作不可撤销。",
  "dictionary.bulkConfirmFilter": "当前筛选：{filter}",
  "dictionary.bulkConfirmAction": "确认删除",
  "dictionary.bulkDeleted": "已删除 {count} 条词库条目",
  ...
  "settings.i18nDictInstalled": "可用 {count} 条参考词条",
  ...
  "settings.i18nDictUpdated": "i18n 模组词典更新完成，可用 {count} 条参考词条",
  "settings.i18nDictTargetOnly": "仅目标语言为 zh_cn 时用于汉化参考；其他目标语言不会加载此词典。",
...
const enUs: TranslationMap = {
  ...
  "auto.error.failedEntries": "{count} entries are still failed or missing. Auto review and packaging were stopped.",
  "nav.dashboard": "Scan",
  "nav.jobs": "Translate",
  ...
  "settings.i18nDictInstalled": "{count} reference entries available",
  ...
  "settings.i18nDictUpdated": "i18n mod dictionary updated, {count} references available",
  "settings.i18nDictTargetOnly": "Only used when the target language is zh_cn; other target languages will not load this dictionary.",
  ...
  "dictionary.selectRow": "Select this entry",
  "dictionary.selectLoaded": "Select loaded entries",
  "dictionary.bulkFilterAll": "All local dictionary entries",
  "dictionary.bulkSelectionIds": "{total} matched, {selected} selected",
  "dictionary.bulkSelectionQuery": "{total} matched, {selected} selected including unloaded entries",
  "dictionary.bulkSelectMatching": "Select matching",
  "dictionary.bulkInvertLoaded": "Invert loaded",
  "dictionary.bulkClearSelection": "Clear selection",
  "dictionary.bulkDeleteSelected": "Delete selected",
  "dictionary.bulkConfirmTitle": "Confirm bulk delete",
  "dictionary.bulkConfirm": "Permanently delete {count} dictionary entries. This cannot be undone.",
  "dictionary.bulkConfirmFilter": "Current filter: {filter}",
  "dictionary.bulkConfirmAction": "Delete",
  "dictionary.bulkDeleted": "Deleted {count} dictionary entries",
...
const jaJp: TranslationMap = {
  ...
  "settings.i18nDictInstalled": "{count} 件の参考語彙が利用可能",
  ...
  "settings.i18nDictUpdated": "i18n Mod 辞書を更新しました。{count} 件の参考語彙が利用可能です",
  "settings.i18nDictTargetOnly": "対象言語が zh_cn の場合のみ参照します。他の対象言語では読み込みません。",
  ...
  "dictionary.selectRow": "この項目を選択",
  "dictionary.selectLoaded": "読み込み済み項目を選択",
  "dictionary.bulkFilterAll": "すべてのローカル辞書項目",
  "dictionary.bulkSelectionIds": "{total} 件一致、{selected} 件選択",
  "dictionary.bulkSelectionQuery": "{total} 件一致、未読み込みを含め {selected} 件選択",
  "dictionary.bulkSelectMatching": "一致項目を全選択",
  "dictionary.bulkInvertLoaded": "読み込み済みを反転",
  "dictionary.bulkClearSelection": "選択解除",
  "dictionary.bulkDeleteSelected": "選択を削除",
  "dictionary.bulkConfirmTitle": "一括削除の確認",
  "dictionary.bulkConfirm": "{count} 件の辞書項目を完全に削除します。この操作は元に戻せません。",
  "dictionary.bulkConfirmFilter": "現在のフィルター: {filter}",
  "dictionary.bulkConfirmAction": "削除",
  "dictionary.bulkDeleted": "{count} 件の辞書項目を削除しました",
  "editPanel.accept": "採用",
  ...
  "dictionary.searchPlaceholder": "原文、訳文、キー、Mod名、ファイル名を検索...",
...
const koKr: TranslationMap = {
  ...
  "settings.i18nDictInstalled": "참고 항목 {count}개 사용 가능",
  ...
  "settings.i18nDictUpdated": "i18n 모드 사전 업데이트 완료, 참고 항목 {count}개 사용 가능",
  "settings.i18nDictTargetOnly": "대상 언어가 zh_cn일 때만 참고 사전으로 사용하며, 다른 대상 언어에서는 로드하지 않습니다.",
  ...
  "dictionary.selectRow": "이 항목 선택",
  "dictionary.selectLoaded": "로드된 항목 선택",
  "dictionary.bulkFilterAll": "모든 로컬 사전 항목",
  "dictionary.bulkSelectionIds": "{total}개 일치, {selected}개 선택됨",
  "dictionary.bulkSelectionQuery": "{total}개 일치, 로드되지 않은 항목 포함 {selected}개 선택됨",
  "dictionary.bulkSelectMatching": "일치 항목 모두 선택",
  "dictionary.bulkInvertLoaded": "로드된 항목 반전",
  "dictionary.bulkClearSelection": "선택 해제",
  "dictionary.bulkDeleteSelected": "선택 삭제",
  "dictionary.bulkConfirmTitle": "일괄 삭제 확인",
  "dictionary.bulkConfirm": "{count}개 사전 항목을 영구 삭제합니다. 되돌릴 수 없습니다.",
  "dictionary.bulkConfirmFilter": "현재 필터: {filter}",
  "dictionary.bulkConfirmAction": "삭제",
  "dictionary.bulkDeleted": "{count}개 사전 항목 삭제됨",
  ...
  "dictionary.searchPlaceholder": "원문, 번역문, 키, 모드명 또는 파일명 검색...",
...
const ruRu: TranslationMap = {
  ...
  "dictionary.searchPlaceholder": "Поиск по исходному тексту, переводу, ключу, моду или файлу...",
  ...
  "settings.i18nDictInstalled": "Доступно справочных записей: {count}",
  ...
  "settings.i18nDictUpdated": "i18n словарь модов обновлен, доступно записей: {count}",
  "settings.i18nDictTargetOnly": "Используется только при целевом языке zh_cn; для других языков этот словарь не загружается.",
  ...
  "dictionary.selectRow": "Выбрать запись",
  "dictionary.selectLoaded": "Выбрать загруженные записи",
  "dictionary.bulkFilterAll": "Все локальные записи словаря",
  "dictionary.bulkSelectionIds": "Найдено {total}, выбрано {selected}",
  "dictionary.bulkSelectionQuery": "Найдено {total}, выбрано {selected}, включая незагруженные",
  "dictionary.bulkSelectMatching": "Выбрать найденные",
  "dictionary.bulkInvertLoaded": "Инвертировать загруженные",
  "dictionary.bulkClearSelection": "Снять выбор",
  "dictionary.bulkDeleteSelected": "Удалить выбранные",
  "dictionary.bulkConfirmTitle": "Подтвердить массовое удаление",
  "dictionary.bulkConfirm": "Будет удалено записей словаря: {count}. Это действие нельзя отменить.",
  "dictionary.bulkConfirmFilter": "Текущий фильтр: {filter}",
  "dictionary.bulkConfirmAction": "Удалить",
  "dictionary.bulkDeleted": "Удалено записей словаря: {count}",
