...
const zhCn: TranslationMap = {
  ...
  "dashboard.stats.actualPendingHint": "所有源语言条目（含已有汉化）",
...
const enUs: TranslationMap = {
  ...
  "dashboard.stats.actualPendingHint": "All source entries (incl. existing translations)",
...
const ruRu: TranslationMap = {
  ...
  "dashboard.stats.actualPending": "Всего в очереди",
  "dashboard.stats.actualPendingHint": "Все исходные записи (вкл. существующие переводы)",
